using _6._02.Turtle1;

namespace _6._02._Turtle1
{
    class Program
    {
        ...
        {
            // Here's our turtle
            //Turtle arthurTheTurtle = new Turtle { PlatformWidth = 10.0, PlatformHeight = 10.0, MotorSpeed = 5.0 };
            var arthurTheTurtle = new Turtle { PlatformWidth = 0.0, PlatformHeight = 10.0, MotorSpeed = 5.0 };
